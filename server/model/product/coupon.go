...
type Coupon struct {
	...
	MinPoint            float32                  `json:"minPoint" form:"minPoint" gorm:"comment:使用门槛；0表示无门槛;size:1"`
	...
	PublishCount        int                      `json:"publishCount" form:"publishCount" gorm:"comment:发行数量;size:11"`
	...
	ProductRelationList []*CouponProductRelation `json:"productRelationList" form:"productRelationList" gorm:"many2many:sms_coupon_product_relation;"`
	//ProductList                 []*Product                       `json:"productList" form:"productList" gorm:"many2many:sms_coupon_product_relation;"`
	ProductCategoryRelationList []*CouponProductCategoryRelation `json:"productCategoryRelationList" form:"productCategoryRelationList" gorm:"many2many:sms_coupon_product_category_relation;"`
}
...
type CouponHistory struct {
	...
	Coupon         Coupon     `json:"coupon" gorm:"foreignKey:ID;references:CouponId"`
}
...
type CouponProductCategoryRelation struct {
	global.GVA_MODEL
	CouponId            int    `json:"couponId" form:"couponId" gorm:"not null;comment:名称;"`
	ProductCategoryId   int    `json:"productCategoryId" form:"productCategoryId" gorm:"not null;comment:物品序号"`
	ProductCategoryName string `json:"productCategoryName" form:"productCategoryName" gorm:"not null;comment:物品序号"`
	ParentCategoryName  string `json:"parentCategoryName" form:"parentCategoryName" gorm:"not null;comment:物品序号"`
}

func (CouponProductCategoryRelation) TableName() string {
...
type CouponProductRelation struct {
	global.GVA_MODEL
	CouponId    int    `json:"couponId" form:"couponId" gorm:"not null;comment:名称;"`
	ProductId   int    `json:"productId" form:"productId" gorm:"not null;comment:物品序号"`
	ProductName string `json:"productName" form:"productName" gorm:"not null;comment:物品序号"`
	ProductSN   string `json:"productSN" form:"productSN" gorm:"not null;comment:物品序号"`
}

func (CouponProductRelation) TableName() string {
