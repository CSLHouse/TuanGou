...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "888", V1: "/product/newList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/product/newProduct", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/product/newProductSort", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/product/newProductState", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/product/newProduct", V2: "DELETE"},
		...
		{Ptype: "p", V0: "8881", V1: "/product/newList", V2: "GET"},
		{Ptype: "p", V0: "8881", V1: "/product/newProduct", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/product/newProductSort", V2: "PUT"},
		{Ptype: "p", V0: "8881", V1: "/product/newProductState", V2: "PUT"},
		{Ptype: "p", V0: "8881", V1: "/product/newProduct", V2: "DELETE"},
