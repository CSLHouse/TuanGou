...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	entities := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: "14", Path: "afterSales", Name: "afterSales", Component: "view/orderManage/afterSales/afterSales.vue", Sort: 4, Meta: Meta{Title: "售后管理", Icon: "Ticket"}},
		...
		{MenuLevel: 0, Hidden: false, ParentId: "19", Path: "list", Name: "list", Component: "view/product/list/index.vue", Sort: 1, Meta: Meta{Title: "商品列表", Icon: "Box"}},
		{MenuLevel: 0, Hidden: false, ParentId: "19", Path: "add", Name: "add", Component: "view/product/add/add.vue", Sort: 2, Meta: Meta{Title: "添加商品", Icon: "Sell"}},
		{MenuLevel: 0, Hidden: false, ParentId: "19", Path: "productCategories", Name: "ProductCategories", Component: "view/product/productCategories/ProductCategories.vue", Sort: 3, Meta: Meta{Title: "商品分类", Icon: "Paperclip"}},
		{MenuLevel: 0, Hidden: false, ParentId: "19", Path: "productType", Name: "ProductType", Component: "view/product/productType/ProductType.vue", Sort: 4, Meta: Meta{Title: "商品类型", Icon: "MagicStick"}},
		{MenuLevel: 0, Hidden: false, ParentId: "19", Path: "brand", Name: "Brand", Component: "view/product/brand/Brand.vue", Sort: 5, Meta: Meta{Title: "品牌管理", Icon: "Medal"}},
		{MenuLevel: 0, Hidden: true, ParentId: "19", Path: "attribute", Name: "Attribute", Component: "view/product/attribute/Attribute.vue", Sort: 6, Meta: Meta{Title: "商品属性参数", Icon: "Medal"}},
		{MenuLevel: 0, Hidden: true, ParentId: "19", Path: "update", Name: "updateProduct", Component: "view/product/update/update.vue", Sort: 7, Meta: Meta{Title: "修改商品", Icon: "Sell"}},
		...
		{MenuLevel: 0, Hidden: false, ParentId: "27", Path: "flashPromotion", Name: "FlashPromotion", Component: "view/marketing/flashPromotion/index.vue", Sort: 1, Meta: Meta{Title: "秒杀活动列表", Icon: "Clock"}},
		{MenuLevel: 0, Hidden: true, ParentId: "27", Path: "productRelation", Name: "productRelation", Component: "view/marketing/flashPromotion/productRelationList.vue", Sort: 2, Meta: Meta{Title: "秒杀商品列表", Icon: "Present"}},
		{MenuLevel: 0, Hidden: true, ParentId: "27", Path: "selectSession", Name: "selectSession", Component: "view/marketing/flashPromotion/selectSessionList.vue", Sort: 3, Meta: Meta{Title: "秒杀时间段选择", Icon: "Box"}},
		{MenuLevel: 0, Hidden: true, ParentId: "27", Path: "session", Name: "session", Component: "view/marketing/flashPromotion/sessionList.vue", Sort: 4, Meta: Meta{Title: "秒杀时间段列表", Icon: "Box"}},
		{MenuLevel: 0, Hidden: false, ParentId: "27", Path: "recommend", Name: "RecommendProduct", Component: "view/marketing/recommend/RecommendProduct.vue", Sort: 5, Meta: Meta{Title: "人气推荐", Icon: "Medal"}},
		{MenuLevel: 0, Hidden: false, ParentId: "27", Path: "brandRecommend", Name: "BrandRecommend", Component: "view/marketing/brandRecommend/brandRecommend.vue", Sort: 6, Meta: Meta{Title: "品牌推荐", Icon: "Sell"}},
		{MenuLevel: 0, Hidden: false, ParentId: "27", Path: "advertise", Name: "Advertise", Component: "view/marketing/advertise/Advertise.vue", Sort: 7, Meta: Meta{Title: "广告列表", Icon: "MagicStick"}},
		{MenuLevel: 0, Hidden: false, ParentId: "27", Path: "newRecommend", Name: "NewRecommend", Component: "view/marketing/newRecommend/NewRecommend.vue", Sort: 8, Meta: Meta{Title: "新品推荐", Icon: "Medal"}},
		{MenuLevel: 0, Hidden: false, ParentId: "27", Path: "coupon", Name: "coupon", Component: "view/marketing/coupon/index.vue", Sort: 9, Meta: Meta{Title: "优惠券", Icon: "Ticket"}},
		{MenuLevel: 0, Hidden: true, ParentId: "27", Path: "addCoupon", Name: "addCoupon", Component: "view/marketing/coupon/add.vue", Sort: 10, Meta: Meta{Title: "添加优惠券", Icon: "Ticket"}},
		{MenuLevel: 0, Hidden: true, ParentId: "27", Path: "couponHistory", Name: "couponHistory", Component: "view/marketing/coupon/history.vue", Sort: 11, Meta: Meta{Title: "优惠券领取详情", Icon: "Ticket"}},
		{MenuLevel: 0, Hidden: true, ParentId: "27", Path: "updateCoupon", Name: "updateCoupon", Component: "view/marketing/coupon/update.vue", Sort: 12, Meta: Meta{Title: "修改优惠券", Icon: "Ticket"}},
		...
		{MenuLevel: 0, Hidden: false, ParentId: "40", Path: "settlementList", Name: "settlementList", Component: "view/settlement/settlementList/settlementList.vue", Sort: 1, Meta: Meta{Title: "结算列表", Icon: "Document"}},
	}
